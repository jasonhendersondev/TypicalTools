...
namespace TypicalTechTools.Controllers
{
    public class WarrantyController : Controller
    {
        ...
        public WarrantyController(IWebHostEnvironment _environment, EncryptionService encryptionService)
        {
        ...
        /// <summary>
        /// Method for uploading a new file. The file is encrypted before being uploaded to the server. User must be authenticated to access.
        /// </summary>
        ...
        public IActionResult Upload(IFormFile file)
        {
            ...
            var encryptedFile = _encryptionService.EncryptByteData(fileContents);

            //Using statement to manage and dispose of our class which implements
            //the management of the byte array in memory.
            using (MemoryStream encDataStream = new MemoryStream(encryptedFile))
            {
        ...
        /// <summary>
        /// Download file method. The file is decrypted before being sent through the File method for download.
        /// </summary>
        ...
        public IActionResult DownloadFile(string filePath) 
        {
            ...
            var decryptedData = _encryptionService.DecryptByteData(bytes);

            // Send the File to Download.
            return File(decryptedData, "application/octet-stream", fileDownloadName: Path.GetFileName(filePath));
